...
class AboutUsScreen extends React.PureComponent {
  constructor(props) {
    ...
    this.state = {
      ...
      data: "<p></p>",
      title: props.navigation  ? props.navigation.getParam('title',"Giới thiệu") : props.title,
      screenType: props.navigation ? props.navigation.getParam('screenType', "ABOUTUS"): props.title,
    };
  }
