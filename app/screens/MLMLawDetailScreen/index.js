...
class MLMLawDetailScreen extends React.PureComponent {
  constructor(props) {
    ...
    this.state = {
      ...
      schema: props.navigation.getParam('schema',""),
      itemIndex: props.navigation.getParam('itemIndex',0),
      maxItemIndex: props.navigation.getParam('maxItemIndex',1),
      title: "",
      content: "",
      documentShortName: props.navigation.getParam('documentShortName',""),
      titleBarText: "",
      _id: ""
    };
  }
