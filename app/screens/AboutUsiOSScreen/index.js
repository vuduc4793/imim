      ...
      <View style={{flex: 1}}>
        <ScrollView
          style={{
            flex: 1,
            alignContent: 'center',
            backgroundColor: Colors.backgroundNumberQuestion,
          }}
          ...
          <View style={[Styles.sectionStyle]}>
            ...
            <Text
              ...
              Phiên bản: {DeviceInfo.getVersion()}. Bản dựng:{' '}
...
html={this.state.contentHTML3} 
            ...
            <TextInput
              ...
              style={{
                ...
                width: '95%',
                marginBottom: 20,
                height: AppDimensions.WINDOW_HEIGHT / 5,
              }}
            ...
            <Button
              ...
              onPress={() => {
                if (!this.state.complainContent) {
                  Alert.alert(
                    'Thông báo',
                    'Vui lòng điền thông tin phản ánh/khiếu nại',
                  );
                  return;
                }
